...
class World(object):
    ...
    def restart(self):
        ...
        while self.vehicle is None:
            spawn_points = self.world.get_map().get_spawn_points()
            spawn_point = spawn_points[17]
            # Town 01 Critical Point
            # spawn_point = carla.Transform(carla.Location(x=1.54, y= 109.40,z=10.37))
...
class ACC_Controller(object):
    ...
    def __init__(self,vehicle, opt_dict={}):
        ...
        self._traffic_detector = TrafficDetector(self._vehicle,self._target_waypoint,12.5,50.0)
    ...
    def set_sampling_radius(self):
        if get_speed(self._vehicle) <= 15.0:
            ...
            return get_speed(self._vehicle) * 0.5 / 3.6  # 0.5 seconds horizon
        elif get_speed(self._vehicle) > 45.0 and get_speed(self._vehicle) <= 65.0:
            return get_speed(self._vehicle) * 0.7 / 3.6
