...
class ACC_Controller(object):
    ...
    def search_overtake_vehicle(self):
        ...
        for target_vehicle in vehicle_list:
            ...
            if is_within_distance_ahead(loc,ego_vehicle_location,
                                        vehicle.get_transform().rotation.yaw,70.0):  
                if (get_speed(target_vehicle) < self.preset_speed * 0.75) and  (self.emergency_brake_situation() is False):   
                    return (True,target_vehicle)
        return (False,None)
    ...
    def set_target_speed(self):
        ...
        if overtake_vehicle_state is False:
            ...
            if front_left_vehicle_state is False:
    ...
    def initialize_PID_controller(self, opt_dict):
        ...
        self._sampling_radius = self._target_speed * 0.8 / 3.6  # 0.5 seconds horizon
