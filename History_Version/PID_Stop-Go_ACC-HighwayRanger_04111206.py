...
class ACC_Controller(object):
    ...
    def __init__(self,vehicle, opt_dict={}):
        ...
        self._traffic_detector = TrafficDetector(self._vehicle,self._target_waypoint,10.0,50.0)
    ...
    def speed_setting(self):
        ...
        print (vehicle_state)
        return get_speed(target_vehicle) if vehicle_state else self.preset_speed
    ...
    def set_PID_controller(self, opt_dict):
        ...
        self._sampling_radius = self._target_speed * 0.5 / 2.5  # 0.5 seconds horizon
    ...
    def run_step(self, debug=True):
        ...
        self._target_speed = self.speed_setting()
