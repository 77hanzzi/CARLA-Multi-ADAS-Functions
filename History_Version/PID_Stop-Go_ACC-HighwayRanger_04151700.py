...
class ACC_Controller(object):
    ...
    def emergency_brake_situation(self):
        ...
        if hazard_vehicle_state:
            if get_speed(hazard_vehicle) <= 0.25 * get_speed(self._vehicle):
                emergency_1 = True
        if light_state:
            emergency_2 = True
    ...
    def set_target_speed(self):
        ...
        if vehicle_state:
            if get_speed(front_vehicle) < self.preset_speed * 0.8 and get_speed(front_vehicle) > get_speed(self._vehicle) * 0.25:
    ...
    def left_lane_change(self):
        ...
        if vehicle_state is False:
            ...
            new_waypoint = self._map.get_waypoint(carla.Location(self._vehicle.get_location().x + 50.0, 
    ...
    def decide_on_overtake(self):    
        ...
        left_vehicle_state, rear_leftvehicle_left_lane = self._traffic_detector.search_rear_vehicle_left_lane()
