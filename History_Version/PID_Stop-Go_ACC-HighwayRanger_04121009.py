...
class ACC_Controller(object):
    ...
    def __init__(self,vehicle, opt_dict={}):
        ...
        self._traffic_detector = TrafficDetector(self._vehicle,self._target_waypoint,12.5,70.0)
    ...
    def targetspeed_setting(self):
        ...
        if vehicle_state is True:
            ...
            #         return float(self._traffic_detector.get_speed_limit()) * 0.80
    ...
    #     if vehicle_state is True:
    #         if get_speed(target_vehicle) < 50.0:
    #             self._waypoints_queue.clear()
    #             new_waypoint = self._map.get_waypoint(carla.Location(self._vehicle.get_location().x + 35.0, 
    #                                                                     self._vehicle.get_location().y - 2.0,
    #                                                                     self._vehicle.get_location().z)) 

    #             self._waypoints_queue.append((new_waypoint, RoadOption.LEFT))
    ...
    def run_step(self, debug=True):
        ...
        vehicle_state, target_vehicle = self._traffic_detector.search_front_vehicle()                
        if vehicle_state:
            print (get_speed(target_vehicle))
        # self.test_trigger()
        ...
        if self.emergency_brake_situation():
            ...
            self._target_speed = self.targetspeed_setting()
