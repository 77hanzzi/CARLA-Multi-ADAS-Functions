...
class ACC_Controller(object):
    ...
    def search_overtake_vehicle(self):
        ...
        for target_vehicle in vehicle_list:
            ...
            if is_within_distance_ahead(loc,ego_vehicle_location,
                                        vehicle.get_transform().rotation.yaw,25.0):        
                return (True,target_vehicle)
        return (False,None)
    ...
    def right_lane_change(self):
        self._waypoints_queue.clear()
        new_waypoint = self._map.get_waypoint(carla.Location(self._vehicle.get_location().x + 125.0, 
                                                                self._vehicle.get_location().y + 3.5,
                                                                self._vehicle.get_location().z)) 
...
def game_loop(args):
    ...
    try:
        ...
        transform_3 = carla.Transform (carla.Location(x=-2430, y=12.25, z=0.4),carla.Rotation(pitch=0, yaw=0, roll=0))
        ...
        carActor_1 = world.world.try_spawn_actor(carModel_1,world.world.get_map().get_spawn_points()[0])
