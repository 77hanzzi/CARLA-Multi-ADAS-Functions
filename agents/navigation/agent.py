...
class Agent(object):
    ...
    def _is_light_red_us_style(self, lights_list, debug=True):
        """
        ...
        if self._local_planner._target_waypoint is not None:            
            suitable_waypoint = optimize_target_waypoint(self._map,self._local_planner._target_waypoint,self._vehicle.get_transform().rotation.yaw)
